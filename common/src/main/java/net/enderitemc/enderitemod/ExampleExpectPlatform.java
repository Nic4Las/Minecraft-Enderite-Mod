...
public class ExampleExpectPlatform {
     ...
     * <p>
     * Example:
     * Expect: net.enderitemc.enderitemod.ExampleExpectPlatform#getConfigDirectory()
     * Actual Fabric:
     * net.enderitemc.enderitemod.fabric.ExampleExpectPlatformImpl#getConfigDirectory()
     * Actual Forge:
     * net.enderitemc.enderitemod.forge.ExampleExpectPlatformImpl#getConfigDirectory()
     * <p>
