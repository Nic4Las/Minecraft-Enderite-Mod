...
@OnlyIn(Dist.CLIENT)
public class EnderiteElytraRenderer<T extends LivingEntity, M extends EntityModel<T>> extends RenderLayer<T, M> {
   private static final ResourceLocation WINGS_LOCATION = new ResourceLocation("textures/entity/enderite_elytra.png");
   private final ElytraModel<T> elytraModel;

   public EnderiteElytraRenderer(RenderLayerParent<T, M> p_174493_, EntityModelSet p_174494_) {
      super(p_174493_);
   ...
   public boolean shouldRender(ItemStack stack, T entity) {
      return stack.is(EnderiteTag.ENDERITE_ELYTRAS);
   }
