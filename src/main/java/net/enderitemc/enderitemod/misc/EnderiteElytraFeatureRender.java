    ...
    public void render(MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, T livingEntity,
        ...
        Identifier identifier = livingEntity instanceof AbstractClientPlayerEntity
                ? (((AbstractClientPlayerEntity) (abstractClientPlayerEntity = (AbstractClientPlayerEntity) livingEntity))
                        ...
                        && ((AbstractClientPlayerEntity) abstractClientPlayerEntity).getElytraTexture() != null
                                ? ((AbstractClientPlayerEntity) abstractClientPlayerEntity).getElytraTexture()
                                : (((AbstractClientPlayerEntity) abstractClientPlayerEntity).canRenderCapeTexture()
        ...
        abstractClientPlayerEntity = ItemRenderer.getArmorGlintConsumer(vertexConsumerProvider,
                RenderLayer.getArmorCutoutNoCull(identifier), false, itemStack.hasGlint());
        this.elytra.render(matrixStack, (VertexConsumer) abstractClientPlayerEntity, i, OverlayTexture.DEFAULT_UV, 1.0f,
                1.0f, 1.0f, 1.0f);
        matrixStack.pop();
    }
